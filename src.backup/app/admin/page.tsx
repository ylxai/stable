                      ...
                      <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                          ...
                          <div className="text-center p-4 bg-blue-50 rounded-lg">
                            ...
                            <div className="text-xs text-blue-600 mt-1">7 days, 14 hours</div>
                          </div>
                          <div className="text-center p-4 bg-purple-50 rounded-lg">
                            <div className="text-2xl font-bold text-purple-600">245ms</div>
                            <div className="text-sm text-purple-800">API Response</div>
                          ...
                          <div className="text-center p-4 bg-orange-50 rounded-lg">
                            ...
                            <div className="text-xs text-orange-600 mt-1">24% of 5GB</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            ...
                            <div>
                              <p className="font-medium text-blue-900">Image Compression Optimization</p>
                              <p className="text-sm text-blue-800">
                                Enable automatic image compression to reduce storage usage by ~40%
                              </p>
                          ...
                          <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-green-800">
                                Database queries are performing well. Average query time: 89ms
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <div>
                              <p className="font-medium text-yellow-900">DSLR Upload Optimization</p>
                              <p className="text-sm text-yellow-800">
                                Consider enabling batch upload for better performance during events
                              </p>
                              <Button size="sm" variant="outline" className="mt-2">
                                Configure Batch Upload
                              </Button>
                            </div>
                          </div>
                        </div>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-center mb-6">
                          ...
                          <div className="text-lg text-gray-700">Excellent Performance</div>
                          <div className="text-sm text-gray-500">Overall system health: 94/100</div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-sm font-medium text-blue-600">88/100</span>
                            </div>
                          </div>
                          <div className="space-y-3">
                            <div className="flex justify-between items-center">
                              <span className="text-sm">DSLR Integration</span>
                              <span className="text-sm font-medium text-green-600">96/100</span>
                            </div>
                            <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-sm font-medium text-green-600">97/100</span>
                            </div>
                          </div>
                        </div>
                      </CardContent>
